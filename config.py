...
# An out-of-stock GPU market defers a round instead of voiding it. The delay
# doubles per attempt so a long outage costs a handful of provider calls per
# hour rather than one every poll interval.
